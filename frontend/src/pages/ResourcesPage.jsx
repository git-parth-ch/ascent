...
import { ExternalLink, Package, BookOpen, Plug, Building2, Layers, FlaskConical } from 'lucide-react';
    ...
    <div className="bg-ascent-bg min-h-screen">
      ...
      <section className="bg-ascent-bg-alt py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <RevealWrapper>
            <pre
              className="font-mono text-xs rounded-xl2 p-6 overflow-auto leading-relaxed"
              style={{
